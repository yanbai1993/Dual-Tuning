...
class EmbeddingHead(nn.Module):
    ...
    def forward(self, features, targets=None, fc_dim=None, pass_head=False,forcenter=False):
        """
        ...
        if not pass_head:
            ...
            # Evaluation
            # fmt: off
            if not self.training and not forcenter:
                return bn_feat
            if not self.training and forcenter:
