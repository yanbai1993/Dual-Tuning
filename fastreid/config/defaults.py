...
_C.MODEL.CENTERPATH=''
_C.MODEL.QUEUE_SIZE=4096
_C.OLDMODEL = CN()
_C.OLDMODEL.CONFIG = ""
_C.OLDMODEL.WEIGHT = ""
_C.OLDMODEL.N2OMAP = ""
_C.OLDMODEL.LOSSES = CN()
_C.OLDMODEL.LOSSES.BCE = CN()
_C.OLDMODEL.LOSSES.BCE.EPSILON = 0.0
_C.OLDMODEL.LOSSES.BCE.ALPHA = 0.2
_C.OLDMODEL.LOSSES.BCE.SCALE = 1.0
...
_C.MODEL.HEADS.DISENTANGLE_DIM1 = 512
_C.MODEL.HEADS.DISENTANGLE_DIM2 = 512
_C.MODEL.HEADS.DISENTANGLE_HARF = False
# ---------------------------------------------------------------------------- #
# REID LOSSES options
# ---------------------------------------------------------------------------- #
_C.MODEL.LOSSES = CN()
...
# if epsilon == 0, it means no label smooth regularization,
# if epsilon == -1, it means adaptive label smooth regularization
_C.MODEL.LOSSES.CENTER.EPSILON = 0.0
_C.MODEL.LOSSES.CENTER.ALPHA = 0.2
_C.MODEL.LOSSES.CENTER.SCALE = 0.1 
_C.MODEL.LOSSES.CENTER.RATE_NEWCENTER=0.5
_C.MODEL.LOSSES.CENTER.ETA=0.7
_C.MODEL.LOSSES.CENTER.QUEUE=True
_C.MODEL.LOSSES.CENTER.INITIAL=False
_C.MODEL.LOSSES.CENTER.MARGIN = 0.3
_C.MODEL.LOSSES.CENTER.NORM_FEAT = False
_C.MODEL.LOSSES.CENTER.HARD_MINING = True

# center
_C.MODEL.LOSSES.N2O = CN()
_C.MODEL.LOSSES.N2O.EPSILON = 0.0
_C.MODEL.LOSSES.N2O.ALPHA = 0.2
_C.MODEL.LOSSES.N2O.SCALE = 0.1 


# center
_C.MODEL.LOSSES.L2 = CN()
_C.MODEL.LOSSES.L2.SCALE = 1 
...
# Triplet N2O Loss options
_C.MODEL.LOSSES.N2OTRI = CN()
_C.MODEL.LOSSES.N2OTRI.MARGIN = 0.3
_C.MODEL.LOSSES.N2OTRI.NORM_FEAT = False
_C.MODEL.LOSSES.N2OTRI.HARD_MINING = True
_C.MODEL.LOSSES.N2OTRI.SCALE = 1.0
_C.MODEL.LOSSES.N2OTRI.TWOWAY = True
...
_C.DATASETS.TEST_DIR = ('./data')
_C.DATASETS.TRAIN_PATH = ('./data')
_C.DATASETS.GALLERY_PATH = ('./data')
_C.DATASETS.QUERY_PATH = ('./data')
...
_C.TEST.AQE.QE_K = 5
_C.TEST.OLDRATE=100  #gallery 旧数据的比例
# Re-rank
_C.TEST.RERANK = CN()
...
_C.TEST.FEATURE_PATH = './logs/feature.bin' 
_C.TEST.MULTIPRESSCING = False 
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "logs/"
